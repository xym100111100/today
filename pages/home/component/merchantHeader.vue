<template>
	<view class="header__content">
		...
		<view class="main" v-if="status==6">
			...
			<view class="speed mt-30 ">
				<view class="item">
					<view class="item__top">
						<image class="icon" src="../../../static/images/index/fu-kuan2.png" style="height: 76rpx; width: 76rpx;" />
						<view class="line active-line">
						</view>
						<view class="line active-line">
						</view>
					</view>
				...
				<view class="item">
					<view class="item__top">
						<image class="icon" src="../../../static/images/index/bei-huo2.png" style="height: 76rpx; width: 76rpx;" />
						<view class="line active-line">
						</view>
						<view class="line">
						</view>
				...
				<view class="item">
					...
					<view class="item__top">
						<image class="icon" src="../../../static/images/index/shen-bao.png" style="height: 76rpx; width: 76rpx;" />
						<view class="line">
						</view>
						<view class="line">
						</view>
				...
				<view>
					<view class="item__top">
						<image class="icon" src="../../../static/images/index/guo-guan.png" style="height: 76rpx; width: 76rpx;" />
						<view class="line">
						</view>
						<view class="line">
						</view>
		...
		<view class="main" v-if="status==7">
			...
			<view class="main__bottom mt-40 ">
				<view class="main__btn btn " @tap="status = 5">
					批次详情
				</view>
				<view class="main__btn" @tap="status = 5">
					确认完成
